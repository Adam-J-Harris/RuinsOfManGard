package 
{
	...
	public class GameOverWinScene extends MovieClip
	{
		...
		public function Initialize(pStage) 
		{
			...
			WinImage = new GameOverWinBackground(centerX, centerY, 800, 450);
			EntityRef.push(WinImage);
			
			backToMenuButton = new button("Menu", 200, 250, this);			
			backToMenuButton.SceneLink = new StartSceneMenu();
			EntityRef.push(backToMenuButton);
			
			restartButton = new button("Retry", 600, 250, this);			
